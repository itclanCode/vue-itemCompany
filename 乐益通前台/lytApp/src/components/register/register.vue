<template lang="html">
  <div class="login">
    ...
    <div class="user_box">
      <input type="text" maxlength="11" class="user" placeholder="请输入注册的手机号" @keyup="userChange" v-model="user"/>
  ...
  // 假设图片验证码
    ...
    methods: {
      ...
      userClear() {
        ...
        this.clickState = false;
        // console.log(123);
        // console.log(this.$route.params); 通过父组件的 路由router-link的编写，和main.js中对路由的配置可以实现路由传参
      },
      // 发送验证码
      sendMsg() {
        // 判断发送按钮的状态
